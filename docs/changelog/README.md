...
| ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------ | ---------- |
| [improve-timer-init-and-kernel-security.md](improve-timer-init-and-kernel-security.md)         | Added `timer_init_freq()` API and secured `task.c` primitives with critical sections to prevent 1000Hz interrupt races  | **Critical** | 2026-03-09 |
