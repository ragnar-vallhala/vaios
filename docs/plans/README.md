...
| Plan | Status | Summary |
|---|---|---|
| [`bus-subsystem.md`](bus-subsystem.md) | In progress (B0–B4 + zero-copy done) | Kernel IPC "Bus": fixed-pool, index-linked pub/sub with guaranteed/best-effort QoS, elastic borrowing, ref-counted delivery, and a multi-producer publish pipeline. |
