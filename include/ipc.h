...
extern "C"
{
    ...
    {
        uint8_t reserved[STATIC_SEMAPHORE_SIZE]; // Adjust depending on your kernel internals
    } StaticSemaphore_t;
    ...
    SemaphoreHandle_t v_semaphore_create_counting_static(uint32_t max_count, uint32_t initial_count,
